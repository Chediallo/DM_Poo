...
public class Pharmacie {
	...
	public static void main(String args[]) {
		...
		while (choix < 4) {
			...
			case 4:
				...
				break;
			default:
				// On reste dans la boucle par défaut.
				choix = 0;
			}
		}
	}
	...
	/**
	 * Méthode auxiliaire de main permettant à un client d'acheter un médicament
	 */
	...
	/**
	 * Méthode auxiliaire de main permettant d'augmenter le stock d'un médicament
	 */
	...
	/**
	 * Méthode auxiliaire de main permettant d'afficher les données stockées dans
	 * les tableaux clients et medicaments
	 */
	static void affichage(Client[] clients, Medicament[] medicaments) {
		...
		for (int i = 0; i < clients.length; i++) {
			System.out.println("Credit du client " + clients[i].getNom() + " :" + clients[i].getCredit());
		}
	}
